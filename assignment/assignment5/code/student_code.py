...
def create_datasets(data_path, input_size, rgb=False):
  ...
  """
    ...
    train_data_tforms.append(transforms.RandomHorizontalFlip())
  ...
  """
    ...
    """
        ...
        self.features = nn.Sequential(
            # layer1
            nn.Conv2d(in_channels=in_channels, out_channels=a, kernel_size=9,
            ...
            # layer2
            nn.Conv2d(in_channels=a, out_channels=b, kernel_size=5,
...
def create_part2_model(model, num_classes):
  ...
  """
    ...
    linear_layer = nn.Linear(4096, num_classes)
    linear_layer.weight.data.normal_(0, 1)
    linear_layer.weight.data.mul_(1e-2)
